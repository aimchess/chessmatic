...
import { ChevronRight, Target, Brain, History, ShieldCheck, Zap } from "lucide-react"
  ...
  return (
    <section className="relative w-full h-[105vh] flex items-center justify-center overflow-hidden bg-slate-950 font-sans">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('/about.png')`, // High-end collaborative/strategic visual
        }}
      >
        {/* Navy Spotlight & Depth Overlay */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-slate-300 font-bold uppercase tracking-[0.4em] text-xs sm:text-sm max-w-2xl mx-auto leading-relaxed">
            Redefining <span className="text-white">Adult Wellness</span> Through <br />
            Strategic Intelligence & Physical Stability.
          </p>
        </motion.div>
      </div>

      {/* 3. FLOATING DASHBOARD BADGES (About Specific) */}
      <div className="absolute inset-0 pointer-events-none hidden xl:block">
        ...
        >
          ...
          <div className="pr-4">
            <p className="text-white/40 text-[10px] font-black uppercase tracking-widest leading-none mb-1.5">Established</p>
            <p className="text-white font-bold text-sm tracking-tight">Singapore HQ</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="pr-4">
            <p className="text-white/40 text-[10px] font-black uppercase tracking-widest leading-none mb-1.5">Methodology</p>
            <p className="text-sky-400 font-bold text-sm tracking-tight">Mind & Body</p>
          </div>
        </motion.div>
      </div>
