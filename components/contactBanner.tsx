...
import { Mail, Phone, MessageSquare, ChevronRight, Globe, Zap, Clock } from "lucide-react"
    ...
    <section className="relative w-full h-[105vh] flex items-center justify-center overflow-hidden bg-slate-950 font-sans">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 text-center">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <h1 className="text-6xl md:text-[110px] font-[1000] text-white tracking-tighter leading-none italic uppercase">
          ...
          <p className="text-slate-300 font-bold uppercase tracking-[0.4em] text-xs sm:text-sm max-w-2xl mx-auto leading-relaxed">
            Our Singapore Laboratory is <span className="text-white">Active.</span> <br />
            Strategy starts with a single conversation.
          </p>
        </motion.div>
      </div>

      {/* 3. FLOATING BADGES (Desktop Only) */}
      <div className="absolute inset-0 pointer-events-none hidden xl:block">
        ...
        >
          <div className="p-3.5 bg-sky-500 rounded-2xl">
            <MessageSquare className="text-white w-6 h-6" />
          </div>
          <div className="pr-4">
            <p className="text-white/40 text-[9px] font-black uppercase tracking-widest leading-none mb-1.5">Direct Line</p>
            <p className="text-white font-bold text-sm tracking-tight">Active Response</p>
          </div>
        </motion.div>
        ...
        >
          <div className="p-3.5 bg-white/10 rounded-2xl">
            <Globe className="text-sky-400 w-6 h-6" />
          </div>
          <div className="pr-4">
            <p className="text-white/40 text-[10px] font-black uppercase tracking-widest leading-none mb-1.5">Global HQ</p>
            <p className="text-white font-bold text-sm tracking-tight">Central Singapore</p>
          </div>
        </motion.div>
      </div>
