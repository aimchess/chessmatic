...
import { ChevronRight, Target, Brain, ShieldCheck, Trophy, Zap } from "lucide-react"
import Link from "next/link"
import { Footer } from "./footer"

export default function AdultClassesBanner() {
  const navy = "#1a365d"
  const cyan = "#0ea5e9"
  ...
  return (
    <section className="relative w-full h-[105vh] flex items-center justify-center overflow-hidden bg-slate-950 font-sans">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('/adult.jpeg')`, // Sophisticated, high-focus chess visual
        }}
      >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 text-center">
        ...
        >
          <div className="flex items-center gap-3 px-6 py-2 rounded-full text-white/70 text-[10px] font-black tracking-[0.3em] uppercase">
            ...
            <span className="text-sky-400">Adult Classes</span>
          </div>
        </motion.div>
        ...
        >
          <h1 className="text-4xl md:text-[80px] font-[1000] text-white tracking-tighter leading-none italic uppercase">
            The <span style={{ color: cyan }}>Strategy.</span>
          </h1>
          <p className="text-slate-300 font-bold uppercase tracking-[0.4em] text-xs sm:text-sm max-w-2xl mx-auto leading-relaxed">
            Advanced <span className="text-white">Adult Coaching</span> for <br />
            Modern Strategic Performance & Executive Focus.
          </p>
        </motion.div>
      </div>

      {/* 3. FLOATING DASHBOARD BADGES (Adult Class Specific) */}
      <div className="absolute inset-0 pointer-events-none hidden xl:block">
        
        {/* LEFT BADGE: COACHING MODE */}
        <motion.div 
          animate={{ y: [0, -20, 0] }}
        ...
        >
          ...
          <div className="pr-4">
            <p className="text-white/40 text-[9px] font-black uppercase tracking-widest leading-none mb-1.5">Coaching Mode</p>
            <p className="text-white font-bold text-sm tracking-tight">Executive Level</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="pr-4">
            <p className="text-white/40 text-[10px] font-black uppercase tracking-widest leading-none mb-1.5">Analysis</p>
            <p className="text-white font-bold text-sm tracking-tight">Deep Logic Lab</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="pr-4">
            <p className="text-white/40 text-[10px] font-black uppercase tracking-widest leading-none mb-1.5">Mastery Curve</p>
            <p className="text-sky-400 font-bold text-sm tracking-tight">85% Logic Gain</p>
          </div>
        </motion.div>
      </div>
