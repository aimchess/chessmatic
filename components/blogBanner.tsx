...
import { ChevronRight, BookOpen, Search, Newspaper, Zap, Brain } from "lucide-react"
  ...
  return (
    <section className="relative w-full h-[105vh] flex items-center justify-center overflow-hidden bg-slate-950 font-sans">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('https://images.unsplash.com/photo-1507842217343-583bb7270b66?q=80&w=2000&auto=format&fit=crop')`, // Intellectual, high-end library/modern space
        }}
      >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-slate-300 font-bold uppercase tracking-[0.4em] text-xs sm:text-sm max-w-2xl mx-auto leading-relaxed">
            Strategic <span className="text-white">Analysis</span>, Mental Endurance <br />
            & The Science of Chessmatic Performance.
          </p>
        </motion.div>
      </div>

      {/* 3. FLOATING DASHBOARD BADGES (Blog Specific) */}
      <div className="absolute inset-0 pointer-events-none hidden xl:block">
        ...
        >
          ...
          <div className="pr-4">
            <p className="text-white/40 text-[9px] font-black uppercase tracking-widest leading-none mb-1.5">Knowledge Base</p>
            <p className="text-white font-bold text-sm tracking-tight">Curated Data</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="pr-4">
            <p className="text-white/40 text-[10px] font-black uppercase tracking-widest leading-none mb-1.5">Frequency</p>
            <p className="text-white font-bold text-sm tracking-tight">Weekly Strategy</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="pr-4">
            <p className="text-white/40 text-[10px] font-black uppercase tracking-widest leading-none mb-1.5">Topic</p>
            <p className="text-sky-400 font-bold text-sm tracking-tight">Cognitive Labs</p>
          </div>
        </motion.div>
      </div>
