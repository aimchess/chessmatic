...
import { ChevronRight, Users, Building2, TrendingUp, Target, ShieldCheck } from "lucide-react"
  ...
  return (
    <section className="relative w-full h-[105vh] flex items-center justify-center overflow-hidden bg-slate-950 font-sans">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2000&auto=format&fit=crop')`, // Professional collaborative high-end visual
        }}
      >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-slate-300 font-bold uppercase tracking-[0.4em] text-xs sm:text-sm max-w-2xl mx-auto leading-relaxed">
            Elite <span className="text-white">Team Performance</span> & <br />
            Strategic Wellness Labs for Modern Corporate Culture.
          </p>
        </motion.div>
      </div>

      {/* 3. FLOATING DASHBOARD BADGES (Corporate Specific) */}
      <div className="absolute inset-0 pointer-events-none hidden xl:block">
        ...
        >
          ...
          <div className="pr-4">
            <p className="text-white/40 text-[9px] font-black uppercase tracking-widest leading-none mb-1.5">Culture Metrics</p>
            <p className="text-white font-bold text-sm tracking-tight">High ROI Output</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="pr-4">
            <p className="text-white/40 text-[10px] font-black uppercase tracking-widest leading-none mb-1.5">Team Status</p>
            <p className="text-white font-bold text-sm tracking-tight">Active Synergy</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="pr-4">
            <p className="text-white/40 text-[10px] font-black uppercase tracking-widest leading-none mb-1.5">Program Hub</p>
            <p className="text-sky-400 font-bold text-sm tracking-tight">Leadership Lab</p>
          </div>
        </motion.div>
      </div>
